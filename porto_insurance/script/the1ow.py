...
params = {'eta': 0.02, 'max_depth': 4, 'subsample': 0.6, 'colsample_bytree': 0.6, 'objective': 'binary:logistic', 'eval_metric': 'auc', 'seed': 99, 'silent': True}
...
test[['id','target']].to_csv('xgb_submission06.csv', index=False, float_format='%.5f')
