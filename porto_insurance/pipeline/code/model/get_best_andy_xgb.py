...
val.to_csv('%s/andy_xgb_valid.csv' % (config.sub_folder), float_format='%.6f', index=False)

# Create submission file
sub = pd.DataFrame()
sub['id'] = id_test
sub['target'] = y_test_pred
sub.to_csv('%s/andy_xgb_submit.csv' % (config.sub_folder), float_format='%.6f', index=False)
