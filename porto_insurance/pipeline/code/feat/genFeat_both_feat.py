"""
  __file__
    genFeat_both_feat.py
  __description__
    this file create  features that tells the relationship of two origin feat
  __author__
    qufu
"""
...
if __name__ == "__main__":
  ...
  dfTrain['both_ps_car_13_x_ps_reg_03'] = dfTrain['ps_car_13'] * dfTrain['ps_reg_03']
  dfTest['both_ps_car_13_x_ps_reg_03'] = dfTest['ps_car_13'] * dfTest['ps_reg_03']
  feat_names = [name for name in dfTrain.columns if "both" in name]
  feat_name_file = "%s/both.feat_name" % config.feat_folder
