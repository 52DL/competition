...
daia_path = "%s/%s/All" % (config.feat_folder, feat_path_name)

daia_train = pd.read_csv("%s/train.feat.csv" % daia_path)
X_train['kinetic_1'] = daia_train['kinetic_1']
X_train['kinetic_2'] = daia_train['kinetic_2']
X_train['kinetic_3'] = daia_train['kinetic_3']
X_train['kinetic_4'] = daia_train['kinetic_4']
del daia_train

daia_test = pd.read_csv("%s/test.feat.csv" % daia_path)
X_test['kinetic_1'] = daia_test['kinetic_1']
X_test['kinetic_2'] = daia_test['kinetic_2']
X_test['kinetic_3'] = daia_test['kinetic_3']
X_test['kinetic_4'] = daia_test['kinetic_4']
del daia_test

one_hot = {c: list(X_train[c].unique()) for c in X_train.columns if c.endswith('_cat')}
...
#x1 = multi_transform(X_train)
#x2 = multi_transform(X_test)
x1 = X_train
x2 = X_test
