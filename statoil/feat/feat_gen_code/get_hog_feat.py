...
print("done..")
csvtrain = pd.DataFrame(trainFeatureData)
csvtrain.columns = ['hog_' + str(c) for c in csvtrain.columns]
csvtrain['id'] = trainDataFrame['id']
csvtrain.to_csv('../hog_train.csv',index=False)
print(csvtrain.shape)
del csvtrain
...
csvtrain = pd.DataFrame(testFeatureData)
csvtrain.columns = ['hog_' + str(c) for c in csvtrain.columns]
csvtrain['id'] = testDataFrame['id']
csvtrain.to_csv('../hog_test.csv',index=False)
print(csvtrain.shape)
